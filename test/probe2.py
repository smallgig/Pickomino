...
import pickomino_env  # IS needed or I get a run time error.

render_mode = None

# render_mode = "human"  # Set to None for no rendering, or "human" for rendering
env = Monitor(gym.make("Pickomino-v0", number_of_bots=2), "./logs/")
print(env)
...
algo.learn(total_timesteps=20_000)  # 1 step = one action! (not episode!)
