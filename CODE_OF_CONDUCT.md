...
3) Temporary Suspension
    1) Event: A pattern of repeated violations, which the Community Moderators have tried to address with warnings, or a
...
4) Permanent Ban
    ...
    2) Consequence: Access to all community spaces, tools, and communication channels is removed. In general, permanent
       bans should rarely be used, should have strong reasoning behind them, and should only be resorted to if working
